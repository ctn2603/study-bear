    ...
    <tr>
      ...
      <td>
        <input
          ...
          name="username"
          value={usersCtx.editUserData.username}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      ...
      <td>
        <input
          ...
          name="title"
          value={usersCtx.editUserData.title}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      <td>
        <input
          ...
          name="pinLocation"
          value={usersCtx.editUserData.pinLocation}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      <td>
        <input
          ...
          name="room"
          value={usersCtx.editUserData.room}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      <td>
        <input
          ...
          name="startTime"
          value={usersCtx.editUserData.startTime}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      <td>
        <input
          ...
          name="endTime"
          value={usersCtx.editUserData.endTime}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      <td>
        <input
          ...
          name="capacity"
          value={usersCtx.editUserData.capacity}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
      ...
      <select 
            ...
            name="major"
            value={usersCtx.editUserData.major}
            onChange={usersCtx.onEditInputChange}
            required>
      ...
      <td>
        <input
          ...
          name="class"
          value={usersCtx.editUserData.class}
          onChange={usersCtx.onEditInputChange}
          required
        ></input>
      </td>
